...
const structuredData = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'inLanguage', title: 'Languages', type: 'array', of: [defineArrayMember({ type: 'string' })], description: 'Language codes for this profile, for example fa-IR and en.' }),
    defineField({ name: 'url', title: 'Primary website URL', type: 'url', validation: (Rule) => Rule.required() }),
    defineField({ name: 'description', title: 'Description', type: 'text', rows: 3 }),
    defineField({ name: 'jobTitle', title: 'Professional titles', type: 'array', of: [defineArrayMember({ type: 'string' })] }),
    defineField({ name: 'knowsAbout', title: 'Areas of expertise', type: 'array', of: [defineArrayMember({ type: 'string' })] }),
